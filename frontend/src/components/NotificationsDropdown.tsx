        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '6px',
              border: 'none',
              background: filter === 'all' ? 'rgba(249,115,22,0.2)' : 'transparent',
              color: filter === 'all' ? '#F97316' : '#9CA3AF',
              fontSize: '0.75rem',
              fontWeight: 600,
              cursor: 'pointer'
            }}
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '6px',
              border: 'none',
              background: filter === 'unread' ? 'rgba(249,115,22,0.2)' : 'transparent',
              color: filter === 'unread' ? '#F97316' : '#9CA3AF',
              fontSize: '0.75rem',
              fontWeight: 600,
              cursor: 'pointer'
            }}
